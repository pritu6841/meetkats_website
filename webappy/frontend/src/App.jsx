      ...
      <AuthProvider>
        <ToastProvider>
          <Routes>
            ...
            <Route
              path="/phone-login"
              element={<AuthPage type="phone-login" />}
            />
            ...
            <Route
              path="/events/:eventId/form/create"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/events/:eventId/register-event"
              element={
                <ProtectedRoute>
                  <RegisterEvent />
                </ProtectedRoute>
            ...
            <Route
              ...
              element={
                <ProtectedRoute>
                  <WithAuth>
                    {(user, logout) => (
                      <NetworkExplorePage user={user} onLogout={logout} />
                    )}
                  </WithAuth>
                </ProtectedRoute>
              }
            ...
            <Route
              path="/portfolio/achievements/new"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/portfolio/streaks/edit/:streakId"
              element={
                <ProtectedRoute>
                  <StreakCreationPage />
                </ProtectedRoute>
            ...
            <Route
              ...
              element={
                <ProtectedRoute>
                  <WithAuth>
                    {(user, logout) => (
                      <EventDetailPage user={user} onLogout={logout} />
                    )}
                  </WithAuth>
                </ProtectedRoute>
              }
            ...
            <Route
              path="/events/:eventId/tickets/manage"
              element={
                <ProtectedRoute>
            ...
            <Route
              path="/tickets/confirmation/:bookingId"
              element={
                <ProtectedRoute>
